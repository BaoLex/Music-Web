...
<div class="main">
    ...
    <div class="top_section">
  		<h5>Top 5 Amazing Song&nbsp;&nbsp;<i class="fa fa-headphones" aria-hidden="true"></i></h5>
  	</div>
    ...
    <div class="small_music_player">
    	<div class="s_player_img">
    		<div class="playing_img">
    			<img src="../Image/hieuthuhai.jpg" alt="">
    		</div>
    	...
    	<div class="song_detail">
    		<p id="song_name">CHƠI</p>
    		<p id="artist_name">Hieuthuhai</p>
    	</div>
    ...
    <div class="popup_music_player">
       ...
       <div class="song_description">
          <h3 id="current_track_name">Chơi</h3>
          <p id="current_singer_name">Hieuthuhai</p>
       </div>
...
<!-- song list file -->
<script src="./TopSongList.js"></script>
<!-- javascript -->
